...
enum TvBadgeVariant { gradient, accent, glass, neutral, success, warning, danger }
  ...
  Widget build(BuildContext context) {
    ...
    final (Color? bg, Gradient? grad, Color text, Color? border) = switch (variant) {
      ...
      TvBadgeVariant.gradient =>
        (null, AppColors.gradientBadge, AppColors.textOnAccent, null),
      TvBadgeVariant.accent =>
        (AppColors.accent, null, AppColors.textOnAccent, null),
      // Glass = badge "AI" cyan signal — GIỮ cyan trọn bộ, không lây gold.
      TvBadgeVariant.glass =>
        (AppColors.glassCyan, null, AppColors.cyan300, const Color(0x4D00F0FF)),
      TvBadgeVariant.neutral =>
        (AppColors.bgOverlay, null, AppColors.textSecondary, AppColors.borderDefault),
      TvBadgeVariant.success =>
        (AppColors.successSoft, null, AppColors.success500, AppColors.successLine),
      TvBadgeVariant.warning =>
        (const Color(0x29FFB020), null, AppColors.warning500, const Color(0x4DFFB020)),
      TvBadgeVariant.danger =>
        (AppColors.dangerSoft, null, AppColors.danger500, AppColors.dangerLine),
    };

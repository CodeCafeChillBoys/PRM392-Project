...
void main() {
  group('orderStatusBadgeData', () {
    test('nhãn tiếng Việt đúng theo trạng thái', () {
      ...
      expect(orderStatusBadgeData(OrderStatus.pendingPayment).$1, 'Chờ thanh toán');
    ...
    test('biến thể badge đúng', () {
      expect(orderStatusBadgeData(OrderStatus.pending).$2, TvBadgeVariant.neutral);
      expect(orderStatusBadgeData(OrderStatus.confirmed).$2, TvBadgeVariant.glass);
      expect(orderStatusBadgeData(OrderStatus.delivered).$2, TvBadgeVariant.success);
      expect(orderStatusBadgeData(OrderStatus.cancelled).$2, TvBadgeVariant.danger);
    });
